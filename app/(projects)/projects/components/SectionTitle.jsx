    ...
    >
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
            <div className="space-y-4 max-w-2xl">
                ...
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                    ...
                    <span className="text-primary">Artifcial Intelligence/full-stack development</span>,{' '}
                    <span className="text-primary">Application Deployment</span>, and{' '}
                    <span className="text-primary">Cloud Infrastructure Support</span>.
                </p>
            </div>
        ...
        <div className="flex items-center gap-6 pt-2 overflow-x-auto pb-2 scrollbar-hide">
            <div className="space-y-1 flex-shrink-0">
                <span className="text-xl sm:text-2xl font-bold text-primary">40+</span>
